...
def fetch_with_date_fallback(
    ...
    *,
    ...
    if fatal_exceptions is None:
        ...
        fatal_types = (DateFetchFatalError, fatal_exceptions)
    elif isinstance(fatal_exceptions, (list, set)):
        types = [t for t in fatal_exceptions if isinstance(t, type) and issubclass(t, Exception)]
        fatal_types = (DateFetchFatalError, *types)
    else:
