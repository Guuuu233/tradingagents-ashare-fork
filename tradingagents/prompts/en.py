...
4. Insufficient/Failed data -> Direction unjudgeable: When social data status is insufficient, empty, failed, timeout, or direction_allowed=False, explicitly state that social direction cannot be determined. The verdict must default to NEUTRAL.
5. Market Attention Separation: Limit-up pool and hot stock rankings reflect market trading focus, not retail social sentiment.
