...
设计状态：已冻结；DAV-905/DAV-907 已实施，DAV-908 已由**代码审核员**对同一 SHA 复审通过，
DAV-909 已受控发布。实施与发布证据见 `work/2026-09-14-p1f-merge-rt-full-6612aea.md` 和
`work/2026-09-14-p1f-release-6cc4e.md`。
...
这是一个已按本设计完成并发布的独立 P1 施工项，但不是收益实验解锁条件。当前只能声称“天梯能力
已按固定当前窗口接入”；尚未执行真实天梯上游请求或真实分析，因此历史分析若需要该字段，必须
明确写不可用，不能声称已有历史天梯证据。
