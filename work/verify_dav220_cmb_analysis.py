...
FORBIDDEN_REPORT_IDS = {"50d1f2f94bf2489db7897eab4c00928e", "dfcf75d53e8343e7bcbdeca8b43ff80d"}
SYMBOL = "600036.SH"

print(f"=== Starting DAV-220 Verification at {datetime.datetime.now()} ===")
...
output_path = f"work/dav220_report_{job_id}.json"
...
# Check current_*_response in risk_debate
...
# 10. Check persistent user config after analyze
print("\n[Step 10] Checking persistent config after analyze...")
