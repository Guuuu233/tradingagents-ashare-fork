#!/usr/bin/env bash
# Deploy is_fatal contract fix ac8955e to local 8000.
...
SHA="ac8955e8cee5dc86da6acc50b5abf6e646dab627"
SERVE="/private/tmp/ta-serve-ac8955e"
PY="$REPO/.venv310/bin/python"
DB="$REPO/data/tradingagents.db"
FRONT_DIST="$REPO/frontend/dist"
TS="$(date +%Y%m%d-%H%M%S)"
LOG="/private/tmp/ta-serve-8000-${TS}-ac8955e.log"
BAK="$REPO/work/tradingagents.db.bak-${TS}-deploy-ac8955e"
