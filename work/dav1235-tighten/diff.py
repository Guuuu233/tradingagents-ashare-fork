"""DAV-1235 重算 diff：baseline(a181e4a) vs candidate 逐 ref/逐 run 对比汇总。

用法：先跑 recompute.py --impl baseline 与 --impl candidate，再跑本脚本。
输出 work/dav1235-tighten/out/diff_summary.md + ref_diff.jsonl。
"""
...
def main() -> None:
    ...
    md = []
    md.append("# DAV-1235 候选 vs a181e4a 重算 diff\n")
