#!/usr/bin/env bash
# Deploy evidence-verifier matcher fix 4a48ec0 to local 8000.
...
SHA="4a48ec0db4c08772cd51af9c6e2386cf687ed492"
SERVE="/private/tmp/ta-serve-4a48ec0"
PY="$REPO/.venv310/bin/python"
DB="$REPO/data/tradingagents.db"
FRONT_DIST="$REPO/frontend/dist"
TS="$(date +%Y%m%d-%H%M%S)"
LOG="/private/tmp/ta-serve-8000-${TS}-4a48ec0.log"
BAK="$REPO/work/tradingagents.db.bak-${TS}-deploy-4a48ec0"
