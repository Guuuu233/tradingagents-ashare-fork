...
SHA="a290f187f18635dfc2c4890cea2645bed9f09f1a"
SERVE="/private/tmp/ta-serve-a290f18"
PY="$REPO/.venv310/bin/python"
DB="$REPO/data/tradingagents.db"
FRONT_DIST="$REPO/frontend/dist"
TS="$(date +%Y%m%d-%H%M%S)"
LOG="/private/tmp/ta-serve-8000-${TS}-a290f18.log"
BAK="$REPO/work/tradingagents.db.bak-${TS}-deploy-a290f18"
