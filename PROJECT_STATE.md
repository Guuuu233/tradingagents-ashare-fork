...
- 施工主干已包含 P1-E 候选 `cd7456012fe2e0b03bd33333e6972301c1c76ddc`（直接父
  `251fd00aa8a9584850cae5d4ab5adfbd3c5d3b94`）及其治理文档后代；本次发布版本为
  `026349614a3f1b92a95dc06c0515f10ebec193bc`。线上服务已切换到同一发布 SHA；完整远端
  文档 HEAD 以 push 后回读为准。
...
| 项目 | 当前核验值 |
|---|---|
| 服务 PID | `19213`（uvicorn，父进程 `71186`；旧 PID `6509` 已优雅停止） |
...
- 仍开放：生产财务报告的披露日 PIT 业务证据、`/limit-up-ladder` 能力补齐及其对应的来源/缺失语义；不能把“连板分布”写成已接入连板天梯。
